...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2017/12/15 17:00:00').on('update.countdown', function(event) {
   ...
   $('.mu-video-play-btn').on('click', function(event) {
	...
	/* ----------------------------------------------------------- */
		...
		$('.panel-collapse').on('shown.bs.collapse', function () {
            $(this).parent().find(".fuq").removeClass("fuq-angle-up").addClass("fuq-angle-down");
		});

		//The reverse of the above on hidden event:

		$('.panel-collapse').on('hidden.bs.collapse', function () {
            $(this).parent().find(".fuq").removeClass("fuq-angle-down").addClass("fuq-angle-up");
		});
